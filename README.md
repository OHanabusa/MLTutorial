...
## 本Tutorialの目的
ここでは，機械学習の全体像を理解し，実装できるようになることを目的とする．また，各自の研究において機械学習を用いることが有効な手段となるような場面において積極的に使うことを望んでいる．例えば，チュートリアル片持ち梁のシミュレーションを用いて，片持ち梁に加える外力に対するたわみ曲線や変位の予測などやってみてもいいかもしれません．
